...
const ChatInput = () => {
  ...
  return (
    <>
      <div className='input-body' style={{ bottom: (messages.length !== 0 || (allVideos.length !== 0 && pathname.includes('/video-playground')) || (allImages.length !== 0 && pathname.includes('/image-playground'))) ? "2%" : "50%" }}>
