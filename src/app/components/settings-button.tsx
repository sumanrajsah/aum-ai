            ...
            <div className="settings-btn-modal" ref={modalRef} >
                ...
                {chatMode === 'image' &&
                    <>
                        {Model === 'dalle-3' && <div className="settings-btn-cont">
                            ...
                            <select className="select-model-btn" onChange={(e) => { setImageSettings(prev => ({ ...prev, size: e.target.value })) }} defaultValue={imageSettings.size}>
                            ...
                            <select className="select-model-btn" onChange={(e) => { setImageSettings(prev => ({ ...prev, style: e.target.value })) }} defaultValue={imageSettings.style}>
                                <option value='vivid'>Vivid</option>
                                <option value='natural'>Natural</option>
                            </select>
                            <hr />
                            <label><Image size={16} />Quality</label>
                            <select className="select-model-btn" onChange={(e) => { setImageSettings(prev => ({ ...prev, quality: e.target.value })) }} defaultValue={imageSettings.quality}>
                        ...
                        {Model.includes('imagen') && <div className="settings-btn-cont">
                            ...
                            <select className="select-model-btn" onChange={(e) => { setImageSettings(prev => ({ ...prev, ratio: e.target.value })) }} defaultValue={imageSettings.ratio}>
                ...
                {chatMode === 'video' &&
                    <>{Model.includes('sora') && <div className="settings-btn-cont">
                        ...
                        <select className="select-model-btn" onChange={(e) => { setVideoSettings(prev => ({ ...prev, resolution: e.target.value })) }} defaultValue={videoSettings.resolution}>
                        ...
                        <hr />
                        <label><MonitorSmartphone size={16} />Ratio</label>
                        <select className="select-model-btn" onChange={(e) => { setVideoSettings(prev => ({ ...prev, ratio: e.target.value })) }} defaultValue={videoSettings.ratio}>
                            <option value='1:1'>1:1</option>
                            <option value='9:16'>9:16</option>
                            <option value='16:9'>16:9</option>
                        </select>
                        ...
                        <select className="select-model-btn" onChange={(e) => { setVideoSettings(prev => ({ ...prev, duration: e.target.value })) }} defaultValue={videoSettings.duration}>
